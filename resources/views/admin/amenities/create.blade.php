<x-layouts.admin :title="__('admin.title.create', ['resource' => __('admin.nav.amenities')])" active="amenities">
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('admin.amenities.store') }}" data-ajax>
            @csrf
            <x-admin.amenity-form :submitLabel="__('admin.amenities.create_submit')" />
        </form>
    </div>
</x-layouts.admin>
