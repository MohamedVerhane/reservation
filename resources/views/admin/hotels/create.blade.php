<x-layouts.admin :title="__('admin.title.create', ['resource' => __('admin.nav.hotels')])" active="hotels">
    ...
    <form method="POST" action="{{ route('admin.hotels.store') }}" enctype="multipart/form-data" data-ajax>
        @csrf
        <x-admin.hotel-form :submitLabel="__('admin.hotels.create_submit')" />
    </form>
