<x-layouts.admin :title="__('admin.title.create', ['resource' => __('admin.nav.room_types')])" active="rooms">
    ...
    <form method="POST" action="{{ route('admin.room-types.store') }}" data-ajax>
        @csrf
        <x-admin.room-type-form :hotels="$hotels" :submitLabel="__('admin.room_types.create_submit')" />
    </form>
